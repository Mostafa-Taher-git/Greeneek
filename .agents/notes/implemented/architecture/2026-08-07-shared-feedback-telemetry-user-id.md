# Agent Note: Shared anonymous user id across telemetry, feedback, and Greeneek requests
...
- One harness home has one anonymous id shared by feedback acknowledgements, session telemetry exports, and direct Greeneek requests.
