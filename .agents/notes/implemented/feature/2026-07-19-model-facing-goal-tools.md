...
- Human slash-command discovery and rendering are owned by the separate [`gnk-command-goal`](../../../../packages/goal/command-goal/README.md) plugin.
