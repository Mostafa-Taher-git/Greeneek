...
The [single-select highlight item](https://github.com/greeneek/greeneek-harness/issues/1687) of the same issue is untouched: focusing the custom field still leaves the previously chosen option visually selected until the first character lands.
