...
Counting `node:fs/promises` calls through the suite's existing module mock, against a store with five project directories — the layout of a real `~/.gnk/sessions`:
