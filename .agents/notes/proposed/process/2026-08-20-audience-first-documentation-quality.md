...
1. Create and validate `gnk-doc`, then rewrite one package README pair as a line-aligned, metadata-bearing prototype without changing runtime claims.
...
- `.agents/skills/gnk-doc` validates and directly links its metadata, structure/hierarchy, and review/prototype references without duplicating their detailed rules in `SKILL.md`.
