...
Greeneek Harness is licensed under [MIT](LICENSE). It depends on the third-party software listed below. Each project remains under its own license; nothing in this file changes those terms.
...
The Cordis framework and its foundation libraries are source-vendored into this repository rather than consumed from npm, and republished under the `@greeneek` scope. All are MIT-licensed; each directory preserves its upstream `LICENSE` file. Exact upstream commits and local modifications are recorded in [`vendor/README.md`](vendor/README.md).

| Package | Upstream name | Upstream | License |
| --- | --- | --- | --- |
| `@greeneek/cosmokit` | `cosmokit` | [github.com/greeneek/cosmokit](https://github.com/greeneek/cosmokit) | MIT |
| `@greeneek/schemastery` | `schemastery` | [github.com/greeneek/schemastery](https://github.com/greeneek/schemastery) | MIT |
| `@greeneek/cordis` | `cordis` | [github.com/cordiverse/cordis](https://github.com/cordiverse/cordis) | MIT |
| `@greeneek/cordis-plugin-loader` | `@cordisjs/plugin-loader` | [github.com/cordiverse/cordis](https://github.com/cordiverse/cordis) | MIT |
| `@greeneek/cordis-plugin-include` | `@cordisjs/plugin-include` | [github.com/greeneek/cordis](https://github.com/greeneek/cordis) | MIT |
| `@greeneek/cordis-plugin-group` | `@cordisjs/plugin-group` | [github.com/greeneek/cordis](https://github.com/greeneek/cordis) | MIT |
| `@greeneek/cordis-plugin-timer` | `@cordisjs/plugin-timer` | [github.com/greeneek/cordis](https://github.com/greeneek/cordis) | MIT |
| `@greeneek/cordis-plugin-hmr` | `@cordisjs/plugin-hmr` | [github.com/greeneek/cordis](https://github.com/greeneek/cordis) | MIT |
| `@greeneek/cordis-plugin-logger-console` | `@cordisjs/plugin-logger-console` | [github.com/greeneek/cordis](https://github.com/greeneek/cordis) | MIT |

## Runtime npm dependencies

External packages that a workspace package resolves at runtime. The tier covers every plugin a user can mount from `cordis.yml` — not only what the `gnk` CLI, Web UI, and Python SDK runtime load by default.
...
`eslint-plugin-sonarjs` (LGPL-3.0-only) and `lightningcss` (MPL-2.0) run only as development tooling; their code is not linked into or distributed with any Greeneek Harness artifact.
...
| [`pydantic`](https://github.com/pydantic/pydantic) | MIT | runtime dependency of `greeneek-harness-sdk` |
...
`@greeneek/node-addon-landlock-run` (and its platform packages) is built and released from this repository under BSD 3-Clause. It is listed here for completeness; it is first-party, not third-party.
