...
/**
 * Packaging-target gate: the bundle must be staged on the OS/arch it ships,
 * and the deployed `node` binary must be executable and probe back the same
 * platform/arch. Run before staging on each CI runner.
 */
