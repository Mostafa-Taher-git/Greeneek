import { CredentialProvider } from '@greeneek/gnk-credentials'
import type {
  CredentialInfo,
  CredentialKey,
  CredentialRecord,
...
/**
 * In-memory credentials provider for the authorization-controller suite. Only
 * the record half is exercised — the controller never touches references — so
 * the reference half answers "nothing stored".
 */
