...
# @greeneek/gnk-client-connection
...
- **There is no logout operation** — clearing the browser cookie ends one browser session; deleting the owner credential record and restarting `gnk` revokes every session.
