...
# @greeneek/gnk-client-ui-agent-preset
...
- [gnk-agent-presets](../../preset/agent-presets/README.md) — the host roster and composition the surfaces read and manage.
