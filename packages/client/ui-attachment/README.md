...
- **Images only** — non-image files have no rail card or history renderer yet; Greeneek Chat-style file cards and upload progress wait until the composer accepts non-image attachments.
