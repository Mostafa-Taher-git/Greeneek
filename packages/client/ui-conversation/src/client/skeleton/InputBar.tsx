...
import type {} from '@greeneek/gnk-plan-mode/client'
// Type-only: the `goal` projection key merge (hint disambiguation).
import type {} from '@greeneek/gnk-goal/client'
...
import type { Translate } from '@greeneek/gnk-client-ui-slots'
        ...
        <div ref={scrollRef} className={css.scroll} data-input-scroll>
          <div className={css.grow}>
            <ComposerContentEditable
              ...
              style={hint === null ? undefined : { '--gnk-composer-hint': JSON.stringify(hint) } as CSSProperties}
            />
            {empty && !claimActive && (
