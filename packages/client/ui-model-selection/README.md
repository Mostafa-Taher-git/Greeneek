...
# @greeneek/gnk-client-ui-model-selection
...
- [gnk-agent-default-model](../../core/agent-default-model/README.md) — the default-model service for sessions that never choose.
