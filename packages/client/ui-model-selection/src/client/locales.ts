...
export const zh = {
  ...
  'detail.switchWithinProvider': 'Switch within this provider',
  'detail.switchProviderFromList': 'Switch provider from the model list',
...
export const en = {
  ...
  'menu.aria': 'Model and effort',
  'menu.model': 'Model',
  'menu.effort': 'Effort',
  'effort.sliderAria': 'Reasoning effort',
