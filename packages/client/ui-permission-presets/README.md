...
# @greeneek/gnk-client-ui-permission-presets
...
- [gnk-permission-presets](../../interaction/permission-presets/README.md) — the host-side permission preset policy these surfaces write.
