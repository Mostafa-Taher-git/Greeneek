---
description: "Shared React UI atoms for the gnk web client: controls, icons, markdown and math rendering, and the terminal/read/diff/search/web output cards (zero cordis)."
