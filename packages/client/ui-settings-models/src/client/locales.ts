...
export const en = {
  ...
  editModelsProvider: 'Edit {provider} models',
  remove: 'Delete',
  ...
  visibilityDescription: 'Choose which {provider} models appear in the selector. Hidden models stay configured and keep serving.',
  visibilityEmpty: 'This provider lists no models to choose from.',
  ...
  welcomeBody: "Greeneek 0.1 remains in testing for Greeneek developers. Many areas need further improvement, and we welcome feedback from the developer community. Greeneek's core plugins and foundational APIs will continue to evolve rapidly over the coming months.\n\nWe look forward to exploring the limits of intelligence with developers around the world, building on open-source, open, reusable, and composable infrastructure. We welcome Greeneek developers everywhere to join the Greeneek plugin ecosystem.",
  welcomeContinue: 'Continue',
  welcomeError: 'The acknowledgement could not be saved. Please try again.',
  onboardingTitle: 'Add an API key to get started',
  onboardingDescription: 'Choose a provider and paste its API key to start building. You can add more later in Settings \u2192 Models.',
  ...
  signInChooseMethod: 'Choose how to sign in:',
  signInWorking: 'Waiting for the provider…',
  signInAnswer: 'Submit',
  signInDecline: 'Decline',
  signInAuthorized: 'Signed in.',
  signInCancelled: 'The sign-in attempt was cancelled.',
}
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  editModels: '编辑模型',
  editModelsProvider: '编辑 {provider} 的模型',
  remove: '删除',
  ...
  fetchAdopt: '添加所选',
  visibilityDescription: '选择在选择器中显示 {provider} 的哪些模型。隐藏的模型保留配置并继续提供服务。',
  visibilityEmpty: '该提供方没有可选择的模型。',
  ...
  creating: '创建中\u2026',
  welcomeTitle: '内测声明',
  welcomeBody: 'Greeneek 目前的 0.1 版本仍处在面向 Greeneek 开发者进行测试的阶段，还有许多地方需要持续改进和打磨，希望听取广大开发者的反馈建议。预计 Greeneek 的核心插件以及基础 API 都会在接下来的一段时间内快速迭代、持续演化。\n\n我们期待与全球开发者一起，在开源、开放、可复用、可组合的基础设施之上，共同探索智能上限。欢迎全球 Greeneek 开发者加入 Greeneek 插件生态。',
  welcomeContinue: '继续',
  welcomeError: '暂时无法保存确认状态，请重试。',
  onboardingTitle: '添加一个 API Key 开始使用',
  onboardingDescription: '选择一个模型提供方并填入其 API 密钥即可开始使用；之后可在“设置 → 模型”中添加更多。',
  ...
  signInChooseMethod: '选择登录方式：',
  signInWorking: '正在等待提供方…',
  signInAnswer: '提交',
  signInDecline: '拒绝',
  signInAuthorized: '登录成功。',
  signInCancelled: '本次登录已取消。',
}
