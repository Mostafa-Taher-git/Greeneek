...
import { PIN_SETTINGS_NAMESPACE, WEB_SEARCH_NS, WebSearchCardController } from './web-search-card-controller.ts'
...
export function apply(ctx: ClientContext): void {
  ...
  const webSearch = new WebSearchCardController(
    ...
    ctx.settingsScope.bind({ namespace: PIN_SETTINGS_NAMESPACE }),
    ctx,
  )
