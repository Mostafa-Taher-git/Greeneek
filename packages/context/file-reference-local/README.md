...
```yaml
- name: '@greeneek/gnk-file-reference-local'
  config:
    maxResults: 20
```
...
- [Filesystem tool catalog](../../../docs/tool-catalog.md#greeneekgnk-tool-fs) — the `read` tool whose namespace discovery must match.
