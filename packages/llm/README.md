---
description: "The LLM capability group: a provider-neutral model-call service, the Greeneek and pi-ai provider adapters, request-retry execution, and replay-aware token measurement."
kind: "package-group"
---
...
| [`llm-greeneek/`](llm-greeneek/README.md) | Serves the `greeneek-official` route with direct Greeneek chat-completions, thinking, and image input | registers on `ctx.llm` |
...
| [`greeneek-llm-api-extensions/`](greeneek-llm-api-extensions/README.md) | Registers lifecycle-owned top-level fields on official Greeneek requests | `ctx.greeneekLlmApiExtensions` |
| [`plugin-package-inventory-greeneek/`](plugin-package-inventory-greeneek/README.md) | Contributes the active Loader package inventory to official Greeneek requests | contributes `gnk_plugin_packages` |
