...
| `timeoutMs` | `60000` | Tool-call timeout budget enforced by `gnk-tool-call-timeout-policy`; covers the complete queued open/query/close lifecycle and is not model-configurable |

The generated [configuration catalog](../../../docs/config-catalog.md#greeneekgnk-tool-lsp) is the exhaustive source for every accepted field.
...
- [gnk-lsp](../lsp/README.md) — the seam this tool queries.
- [gnk-lsp-stdio](../lsp-stdio/README.md) — the stdio provider that answers these queries.
...
The model sees the generated [`lsp` schema](../../../docs/tool-catalog.md#greeneekgnk-tool-lsp).
