...
- name: '@greeneek/gnk-session-title'
  config:
    fallbackMaxWords: 8
    fallbackMaxBytes: 96
    maxTitleBytes: 120
...
The generated [configuration catalog](../../../docs/config-catalog.md#greeneekgnk-session-title) is the exhaustive source for every accepted field and its JSDoc.
