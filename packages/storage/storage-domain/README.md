...
The generated [configuration catalog](../../../docs/config-catalog.md#greeneekgnk-storage-domain) is the exhaustive source for every accepted field and its JSDoc.
