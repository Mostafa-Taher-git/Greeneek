...
The generated [configuration catalog](../../../docs/config-catalog.md#greeneekgnk-storage-json) is the exhaustive source for every accepted field and its JSDoc.
