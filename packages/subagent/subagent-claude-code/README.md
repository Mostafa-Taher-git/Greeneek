...
- [Generated configuration catalog](../../../docs/config-catalog.md#greeneekgnk-subagent-claude-code) — every accepted config field and its source declaration.
