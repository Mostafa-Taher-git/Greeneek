---
description: "The model-facing todo_write tool over the Greeneek Harness session log: whole-list replacement, per-session ownership, and the todos projection, for users and maintainers choosing, configuring, or debugging the tool."
...
The generated [configuration catalog](../../../docs/config-catalog.md#greeneekgnk-tool-todo) is the exhaustive source for the accepted field.
...
- [Generated tool catalog](../../../docs/tool-catalog.md#greeneekgnk-tool-todo) — the `todo_write` schema the model receives.
- [Generated configuration catalog](../../../docs/config-catalog.md#greeneekgnk-tool-todo) — every accepted config field and its source declaration.
