...
- [Generated tool catalog](../../docs/tool-catalog.md#greeneekgnk-tool-workflow) — the `workflow` tool schema the model receives.
- [Generated tool catalog](../../docs/tool-catalog.md#greeneekgnk-tool-ralph) — the `ralph` tool schema the model receives.
- [Generated configuration catalog](../../docs/config-catalog.md#greeneekgnk-workflow-worker-thread) — every accepted engine config field.
