...
/**
 * Render the complete deterministic package graph, English-only.
...
/** CLI entry: regenerate by default, or verify all outputs with `--check`. @returns Nothing. */
